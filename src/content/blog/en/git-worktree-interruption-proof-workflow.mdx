...
<WorktreeBranches
	...
	description="Two independent worktrees sharing Git data while keeping their files, processes, and branch context separate"
/>
...
<Disclosure summary="What Worktrunk handles for you">
	<ul>
		<li>Creates and locates worktrees by branch name.</li>
		<li>Runs setup hooks when a worktree is created.</li>
		<li>Handles merge, rebase, squash, and cleanup workflows.</li>
	</ul>
</Disclosure>
