...
<Image
	...
	widths={[320, 640, 960, 1520, 2236]}
	sizes="(max-width: 639px) calc(100vw - 72px), (max-width: 1023px) 600px, 760px"
...
<WorktreeBranches
	leftBranch="arbitrum-stylus-support"
	rightBranch="optimism-fix"
	description="Dos worktrees independientes que comparten datos de Git mientras mantienen separados sus archivos, procesos y contexto de branch"
/>
...
<Disclosure summary="Lo que Worktrunk resuelve por ti">
	<ul>
		<li>Crea y encuentra worktrees por nombre de branch.</li>
		<li>Ejecuta hooks de setup al crear un worktree.</li>
		<li>Gestiona los workflows de merge, rebase, squash y limpieza.</li>
	</ul>
</Disclosure>
